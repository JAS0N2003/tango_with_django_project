...
def populate():
    ...
    python_pages = [
        ...
        'url':'http://www.korokithakis.net/tutorials/python/', 'views': 9} ]

    django_pages = [
        {'title':'Official Django Tutorial',
        'url':'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views': 92},
        {'title':'Django Rocks',
        'url':'http://www.djangorocks.com/', 'views': 185},
        {'title':'How to Tango with Django',
        'url':'http://www.tangowithdjango.com/', 'views': 29} ]

    other_pages = [
        {'title':'Bottle',
        'url':'http://bottlepy.org/docs/dev/', 'views': 47},
        {'title':'Flask',
        'url':'http://flask.pocoo.org', 'views': 99} ]
